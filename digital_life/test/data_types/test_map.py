...
from digital_life.src.data_types.map import Map
...
class TestMap(TestCase):
    def setUp(self) -> None:
        self._height = 1000
        self._width = 2000
        self._map = Map(height=self._height, width=self._width)

    def test_init_sets_height(self):
        # Arrange
        # Act
        # Assert
        self.assertEqual(self._map.height, self._height)

    def test_init_sets_width(self):
        # Arrange
        # Act
        # Assert
        self.assertEqual(self._map.width, self._width)

    def test_init_starts_with_no_entities(self):
        # Arrange
        # Act
        # Assert
        self.assertEqual(len(self._map.get_entities()), 0)
    ...
    def test_init_starts_with_no_entities_with_location(self):
        ...
        self.assertEqual(
            len(
                self._map.get_entities_overlapping_location(
    ...
    def test_init_add_entity(self):
        ...
        # Assert
        self.assertEqual(len(self._map.get_entities()), 1)
        self.assertSetEqual(self._map.get_entities(), {entity})
    ...
    def test_init_add_entities(self):
        ...
        for mock_entity in mock_entities:
            self._map.add_entity(mock_entity)

        # Assert
        self.assertEqual(len(self._map.get_entities()), count)
        self.assertSetEqual(self._map.get_entities(), set(mock_entities))
    ...
    def test_del_entities(self):
        ...
        for _entity in entities[::2]:
            _entity.delete()
        # Assert
        self.assertEqual(len(self._map.get_entities()), count / 2)
        self.assertSetEqual(self._map.get_entities(), set(entities[1::2]))
    ...
    def test_entity_location_updated(self):
        ...
        # Assert
        self.assertEqual(len(self._map.get_entities_overlapping_location(test_location_one)), 0)
        self.assertEqual(len(self._map.get_entities_overlapping_location(test_location_two)), 1)
        self.assertSetEqual(self._map.get_entities_overlapping_location(test_location_two), {entity})
    ...
    def test_entities_overlapping_location_no_entity_inside(self):
        ...
        # Act
        # Assert
        self.assertEqual(len(self._map.get_entities_overlapping_location(test_location_two)), 0)

    def test_entities_overlapping_location_one_entity_inside(self):
        # Arrange
        world = Map(height=self._height, width=self._width)
    ...
    def test_entities_overlapping_location_some_of_many_entities_inside(self):
        ...
        # Act
        # Assert
        self.assertEqual(len(self._map.get_entities_overlapping_location(test_location_two)), count / 2)
        self.assertSetEqual(self._map.get_entities_overlapping_location(test_location_two), set(entities[1::2]))
